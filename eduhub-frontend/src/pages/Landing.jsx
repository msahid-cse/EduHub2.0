...
//   return (
//     <div className="max-w-md mx-auto my-12 p-8 rounded-xl bg-gradient-to-br from-gray-900/50 to-gray-900/80 border border-gray-800 shadow-2xl backdrop-blur-md">
//       <div className="text-center mb-8">
//         <h2 className="font-['Inter'] text-3xl font-bold text-white mb-2">Welcome Back</h2>
//         <p className="font-['Source_Sans_Pro'] text-gray-400">Sign in to your account</p>
//       </div>
      
//       <div className="space-y-4">
//         <div>
//           <label className="font-['Source_Sans_Pro'] text-gray-300 block mb-2">Email</label>
//           <input
//             type="email"
//             value={email}
//             onChange={(e) => setEmail(e.target.value)}
//             className="w-full px-4 py-3 rounded-full bg-black/20 text-white border border-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all duration-300 shadow-sm"
//             placeholder="your@email.com"
//           />
//         </div>
        
//         <div>
//           <label className="font-['Source_Sans_Pro'] text-gray-300 block mb-2">Password</label>
//           <input
//             type="password"
//             value={password}
...
//         <button className="font-['Source_Sans_Pro'] font-semibold w-full px-6 py-3 rounded-full transition-all duration-300 flex items-center gap-2 shadow-lg border-2 bg-gradient-to-r from-teal-500 to-cyan-500 text-white border-transparent hover:from-teal-600 hover:to-cyan-600 hover:scale-105 justify-center mt-6">
//           Sign In
//         </button>
        
//         <div className="text-center mt-4">
//           <button 
//             className="font-['Source_Sans_Pro'] text-teal-400 hover:text-teal-300 transition-colors flex items-center justify-center mx-auto"
